...
//     const assets = [
//         '/assets/circle.png',
//         '/assets/readyForWork.gif',
//         '/assets/working.gif',
//         '/assets/recovering.gif',
//         '/assets/img.webp'
//     ];
//
//     useEffect(() => {
...
//                                         <img
//                                             src={'/assets/readyForWork.gif'}
//                                             className="relative z-10 h-[44vh] w-[44vh] cursor-pointer"
//                                             alt="Ready for Work"
//                                         />
//                                     ) : (
//                                         <img
//                                             src={'/assets/working.gif'}
//                                             className="relative z-10 h-[44vh] w-[44vh] cursor-not-allowed"
//                                             alt="Working"
//                                         />
//                                     )
//                                 ) : energy < 100 ? (
//                                     <img
//                                         src={'/assets/recovering.gif'}
//                                         className="relative z-10 h-[44vh] w-[44vh] cursor-not-allowed"
//                                         alt="Recovering"
//                                     />
//                                 ) : (
    ...
    const updateEnergyAndFarming = () => {
        ...
        if (lastUpdate && startTime) {
            ...
            if (totalElapsed <= duration) {
                ...
                const reverseElapsed = totalElapsed - duration;
                const recoveryStep = 100 / duration;
                const updatedEnergy = recoveryStep * reverseElapsed;
                const updatedFarming = 100 - recoveryStep * reverseElapsed;
                setEnergy(updatedEnergy < 100 ? updatedEnergy : 100);
                setFarming(updatedFarming > 0 ? updatedFarming : 0);

                if (updatedEnergy >= 100 && updatedFarming <= 0) {
                    setIsRecovering(false); // Завершение восстановления
                }
            }
        }
    };
